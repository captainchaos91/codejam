...
public class AlienLanguageTest extends AbstractCodejamTest
{
    ...
    public void testWithSmallInput() throws IOException
    {
        ...
        assertEquals(MESSAGE, readFileToString(new File(path + AlienLanguage.OUT_SMALL)), readFileToString(new File(path + "solution-small.out")));
    }
    ...
    public void testWithLargeInput() throws IOException
    {
        ...
        assertEquals(MESSAGE, readFileToString(new File(path + AlienLanguage.OUT_LARGE)), readFileToString(new File(path + "solution-large.out")));
    }
